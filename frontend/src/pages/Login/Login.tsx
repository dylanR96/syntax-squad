...
// Desktop sida för register
// Fler breakpoints för slogan
// Bättre namn på css klasser (speciellt "checkbox")
// Byt ut svg pathsen mot länkade imgs
...
const Login = () => {
  return (
    <main className="main-login">
      ...
      >
        <path
          d="M385 2.99964C445.333 -0.333696 567 10.0996 571 78.4996C576 164 463.5 122 314 120.5C164.5 119 2 148 2 216.5C2 285 165.46 272.535 227 265C302.5 255.755 465 227.5 502.5 265C540 302.5 372 298.5 343 377.5"
          stroke="white"
          strokeWidth="3"
          strokeLinecap="round"
